...
public class Mario extends Sprite {
    ...
    public Mario(PlayScreen screen){
        ...
        marioRun = new Animation(0.1f, frames); //duration, array
        frames.clear();

        for(int i = 4; i<6; i++){
            frames.add(new TextureRegion(getTexture(),i * 16, 11, 16, 16));
        }
        marioJump = new Animation(0.1f, frames); //duration, array
        frames.clear();
    ...
    public void defineMario(){
        ...
        head.set(new Vector2(-3/ SuperMario.PPM, 8/ SuperMario.PPM), new Vector2(3/ SuperMario.PPM, 8/ SuperMario.PPM));
        fdef.shape = head;
        fdef.isSensor = true;
